          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div className="relative rounded-3xl overflow-hidden shadow-2xl">
              ...
              <div className="absolute bottom-8 left-8 right-8 flex gap-4">
                <Button variant="secondary" size="md" className="flex-1 bg-white/95 hover:bg-white text-gray-800 shadow-lg">
                  Đăng nhập
                </Button>
                <Button variant="primary" size="md" className="flex-1 bg-gradient-to-r from-yellow-400 to-orange-500 shadow-lg">
                  Đăng ký
                </Button>
              </div>
            </div>
